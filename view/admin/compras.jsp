    ...
    <body>
            ...
            <form action="Movimientos" method="post" style="margin: auto; display: table"> 
                ...
                <fieldset>
                    <input type="hidden" name="tipo" style="width: 400px;"
                           value="compra" readonly="readonly"/>

                    <legend class="text-success text-center"> REGISTRAR NUEVA COMPRA</legend>
                    ...
                    <p class="text-right">
                        <button type="submit" class="btn btn-primary btn-lg"><i class="far fa-save"></i></span> &nbsp; COMPRAR </button> &nbsp;
        ...
        <script type="text/javascript">
            function recargaar() {
                ...
                if (campo === null) {
                    window.location = "Movimientos?accion=CBO&target=view/admin/compras";
                }
            }
        </script>
